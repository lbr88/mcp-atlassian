...
def test_get_project_fields_accepts_cloud_fields_array(projects_mixin: ProjectsMixin):
    """Cloud's fields response contributes to the consumer's project schema."""
    projects_mixin.get_project_issue_types = MagicMock(
    ...
    assert projects_mixin.get_project_fields("PROJ1") == [
        {
            "field_id": "summary",
            "name": "Summary",
            "required": True,
