...
class TestRealJiraAPI(BaseAuthTest):
    ...
    def test_attachment_upload_download(
        self, jira_client, test_project_key, created_issues, workspace_tmp_path
    ):
        ...
        try:
            # Create test file
            test_file = workspace_tmp_path / "test_attachment.txt"
...
class TestRealConfluenceAPI(BaseAuthTest):
    ...
    def test_attachment_handling(
        self, confluence_client, test_space_key, created_pages, workspace_tmp_path
    ):
        ...
        try:
            # Create test file
            test_file = workspace_tmp_path / "confluence_test.txt"
